...
ActiveRecord::Schema.define(version: 2020_10_11_060250) do
  ...
  create_table "products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["audition_id"], name: "index_products_on_audition_id"
  ...
  create_table "sending_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_sending_addresses_on_user_id"
  end
  ...
  add_foreign_key "sending_addresses", "users"
end
